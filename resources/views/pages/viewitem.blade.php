                    ...
                    <div class="card-body">
                        <form action="/updateitem/{{ $barang->id }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ $barang->namabarang }}" name="namabarang"
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="inputid" name="itemid"
                                        value="{{ $barang->itemid }}" disabled>
                                </div>
                            </div>
                            <div class="mb-4">
                                <label for="exampleInputEmail1" class="form-label">Stock</label>
                                <input type="text" value="{{ $barang->stok }}" name="stok" class="form-control"
                                    aria-describedby="emailHelp">
                            </div>
                            <div class="mb-4">
                                <label for="exampleInputEmail1" class="form-label">Description</label>
                                <input type="text" value="{{ $barang->keterangan }}" name="keterangan"
                                    class="form-control" aria-describedby="emailHelp">
                            </div>
                            <div class="mb-4">
                                <label for="exampleInputEmail1" class="form-label">Images</label>
                                <input type="file" value="{{ $barang->images }}" name="images" class="form-control"
                                    aria-describedby="emailHelp">
                            </div>
